...
const rolePermissions = {
  solo_lectura: ['siigo_get_products', 'siigo_get_product', 'siigo_search_products', 'siigo_get_customers', 'siigo_get_customer', 'siigo_search_customers', 'siigo_get_quotations', 'siigo_get_quotation', 'siigo_list_invoices', 'siigo_get_invoice', 'siigo_get_warehouses', 'siigo_get_price_lists', 'siigo_get_document_types', 'siigo_get_taxes', 'siigo_get_payment_types', 'siigo_get_cost_centers', 'siigo_get_users', 'siigo_get_cities', 'siigo_get_id_types', 'siigo_get_fiscal_responsibilities', 'siigo_get_fixed_assets', 'siigo_get_expenses', 'siigo_get_misc_income'],
  ventas: ['siigo_get_products', 'siigo_get_product', 'siigo_search_products', 'siigo_get_customers', 'siigo_get_customer', 'siigo_search_customers', 'siigo_get_quotations', 'siigo_get_quotation', 'siigo_create_quotation', 'siigo_update_quotation', 'siigo_list_invoices', 'siigo_get_invoice', 'siigo_create_invoice', 'siigo_get_warehouses', 'siigo_get_price_lists', 'siigo_get_document_types', 'siigo_get_taxes', 'siigo_get_payment_types', 'siigo_get_cost_centers', 'siigo_get_users', 'siigo_get_cities', 'siigo_get_id_types', 'siigo_get_fiscal_responsibilities', 'siigo_get_fixed_assets', 'siigo_get_expenses', 'siigo_get_misc_income'],
  bodega: ['siigo_get_products', 'siigo_get_product', 'siigo_search_products', 'siigo_get_customers', 'siigo_get_customer', 'siigo_search_customers', 'siigo_create_product', 'siigo_update_product', 'siigo_create_customer', 'siigo_update_customer', 'siigo_get_quotations', 'siigo_get_quotation', 'siigo_list_invoices', 'siigo_get_invoice', 'siigo_get_warehouses', 'siigo_get_price_lists', 'siigo_get_document_types', 'siigo_get_taxes', 'siigo_get_payment_types', 'siigo_get_cost_centers', 'siigo_get_users', 'siigo_get_cities', 'siigo_get_id_types', 'siigo_get_fiscal_responsibilities', 'siigo_get_fixed_assets', 'siigo_get_expenses', 'siigo_get_misc_income'],
